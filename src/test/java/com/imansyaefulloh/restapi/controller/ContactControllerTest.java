...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        CreateContactRequest request = new CreateContactRequest();
        request.setFirstName("Iman");
        request.setLastName("Syaefulloh");
        request.setEmail("iman@gmail.com");
        ...
        mockMvc.perform(
            ...
            assertEquals("Iman", response.getData().getFirstName());
            assertEquals("Syaefulloh", response.getData().getLastName());
            assertEquals("iman@gmail.com", response.getData().getEmail());
    ...
    void getContactSuccess() throws Exception {
        ...
        contact.setFirstName("Iman");
        contact.setLastName("Syaefulloh");
        contact.setEmail("iman@gmail.com");
